...
export const EncryptedOptimizationLogForm: FunctionalComponent = () => {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    try {
      ...
      // Submit using dual-chain orchestrator (Solana + optional Aleo verification)
      ...
      if (result.solana.success) {
        ...
        setSuccessData({
          ...
          optimizationLogId,
          explorerUrl:
            result.dualStatus.solana.explorerUrl ||
            `https://explorer.solana.com/tx/${signature}?cluster=${SOLANA_CONFIG.network}`,
