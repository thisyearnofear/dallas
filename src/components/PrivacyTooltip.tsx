...
const PRIVACY_EXPLANATIONS: Record<PrivacyTopic, PrivacyExplanation> = {
  encryption: {
    ...
    whyItMatters: 'Even if our servers are hacked, your agent data remains unreadable without your wallet key.',
    withoutIt: 'Your sensitive agent information could be exposed in a data breach.',
  },
  zk_proofs: {
  ...
  compression: {
    ...
    whyItMatters: 'Makes it affordable to store detailed agent records on the blockchain.',
  ...
  mpc: {
    ...
    withoutIt: 'A single compromised account could expose your agent information.',
  },
  wallet_key: {
    ...
    withoutIt: 'The platform could potentially decrypt and view your agent information.',
  },
  validator_privacy: {
    title: 'Validator Privacy',
    shortExplanation: 'Validators verify quality without seeing sensitive data',
    whyItMatters: 'Production experts can ensure data quality while your privacy is preserved.',
  ...
  research_access: {
    ...
    whyItMatters: 'Your data contributes to production research while your identity and details stay private.',
    withoutIt: 'Research would require exposing developer identities and sensitive agent details.',
  },
};
